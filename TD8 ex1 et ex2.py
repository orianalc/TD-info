# -*- coding: utf-8 -*-
"""
Created on Wed May 29 11:36:14 2024
...
def creer_ficher(header, voie1, voie2):
    with open("oriana.wav","wb") as f: #si le fichier existe pas ça le créer. Ca le met en mode Writing en binaire : 'wb'
        f.write(header) #ça écrit dans le fichier 
        for i in range(len(voie1)):
            ...
            f.write(var1) #ça ecrit à la suite
            var2 = struct.pack("h",voie1[i])
            f.write(var2)


#Le fichier à été créé dans le même dossier que le fichier Python sous le nom 'oriana.wav'
#On peut l'écouter maintenant !!!
creer_ficher(header, voie1_the_wall, voie2_the_wall)