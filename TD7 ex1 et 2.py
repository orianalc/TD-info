# -*- coding: utf-8 -*-
"""
Created on Wed May 22 09:55:07 2024
...
A = Graph()
A.min_local(3, A.graph, A.tab_color)
print('attribut A.tab_color après la commande :')
print('A.min_local(3, A.graph, A.tab_color)')
print('\n')
print(A.tab_color)
